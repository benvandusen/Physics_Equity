...
rats2 <- foreach(i=1:10, .combine=rbind) %do% {
...
#things to delete
#Makes the ratios. This is slightly better but there must still be a better way.
ratios <- data.frame(name = c(p3est$race_gender[2],p3est$race_gender[4],p3est$race_gender[6],p3est$race_gender[8],p3est$race_gender[10],p3est$race_gender[12],p3est$race_gender[14],p3est$race_gender[16],p3est$race_gender[18],p3est$race_gender[20]),
                     ratio = c(p3est$Q[1]/p3est$Q[2],p3est$Q[3]/p3est$Q[4],p3est$Q[5]/p3est$Q[6],p3est$Q[7]/p3est$Q[8],p3est$Q[9]/p3est$Q[10],p3est$Q[11]/p3est$Q[12],p3est$Q[12]/p3est$Q[14],p3est$Q[15]/p3est$Q[16],p3est$Q[17]/p3est$Q[18],p3est$Q[19]/p3est$Q[20]))
...
rm(i)
i=1
sqrt( (p3est$Q[2*i-1]/p3est$Q[2*i])^2 *  ((p3est$T[2*i])/(p3est$Q[2*i]^2)  +  (p3est$T[2*i-1])/(p3est$Q[2*i-1]^2)  -2*(p3est[2*i,(11+2*i)]/((p3est$Q[2*i-1])*(p3est$Q[2*i])) )))

sqrt( (p3est$Q[2*1-1]/p3est$Q[2*1])^2 *  ((p3est$T[2*1])/(p3est$Q[2*1]^2)  +  (p3est$T[2*1-1])/(p3est$Q[2*1-1]^2)  -2*(p3est[2*1,(11+2*1)]/((p3est$Q[2*1-1])*(p3est$Q[2*1])) )))
