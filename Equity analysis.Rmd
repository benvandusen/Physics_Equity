...
gain3 <- with(MIdata,{lmer(gain~1 + stud_pre_cent + class_pre_cent + lec (1|course_id))})
gain4 <- with(MIdata,{lmer(gain~1 + stud_pre_cent + class_pre_cent + lec + retake + (1|course_id))})
gain4 <- with(MIdata,{lmer(gain~1 + stud_pre_cent + female + asian + black + other + Hispanic + lec + retake + (1|course_id))})
gain5 <- with(MIdata,{lmer(gain~1 + stud_pre_cent + female*(asian + black + other + Hispanic) + lec + retake + (1|course_id))})
gain6 <- with(MIdata,{lmer(gain~1 + stud_pre_cent + female*(asian + black + other + Hispanic) + female*lec + retake + (1|course_id))})
gain7 <- with(MIdata,{lmer(gain~1 + lec*female*(asian + black + other + Hispanic) + stud_pre_cent + retake + (1|course_id))})
gain8 <- with(MIdata,{lmer(gain~1 + lec*female*(asian + black + other + Hispanic) + stud_pre_cent + retake + (1 + stud_pre_cent + gend_URM + race_URM |course_id))})
